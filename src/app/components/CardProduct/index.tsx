    ...
    return (
        <button type="button" onClick={()=>handleNavigate()} onMouseEnter={()=> setVisible(true)} onMouseLeave={()=> setVisible(false)} className={`bg-white duration-500 max-sm:w-[72%] opacity-${opacity} shadow-2xl flex flex-col items-center m-4 rounded-xl hover:cursor-pointer duration-200 hover:scale-105`}>
            <div className="relative">
                <img className="w-full object-cover h-60 rounded-t-xl" src={name == "Engate Rápido" ? EngateRapido : name == "Tesoura Hidráulica" ? TesouraHidraulica : name == "Compactadores" ? Compactadores : name == "Rompedores" ? 'https://hfx-equipamentos-images.s3.sa-east-1.amazonaws.com/HR130%230195d92b-776d-4662-b233-1d14137b1f95.png' : image} alt="Imagem do Produto" />
